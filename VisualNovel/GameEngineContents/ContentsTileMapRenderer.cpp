...
void ContentsTileMapRenderer::CreateTileMap(const CreateTileParameter& _Parameter)
{
...
void ContentsTileMapRenderer::Start()
{
	ContentsSpriteRenderer::Start();
}

void ContentsTileMapRenderer::SetTilePos(const SetTileParameterPos& _Parameter)
{
...
void ContentsTileMapRenderer::SetTileIndex(const SetTileParameterIndex& _Parameter)
{
...
void ContentsTileMapRenderer::Render(GameEngineCamera* _Camera, float _Delta)
{
